...
export default function MembersPage() {
  ...
  // Проверка доступа: SUPER_ADMIN и администраторы организаций
  const allowedRoles = ['SUPER_ADMIN', 'FEDERAL_CHAIRMAN', 'REGIONAL_CHAIRMAN', 'LOCAL_CHAIRMAN', 'PRIMARY_CHAIRMAN'];
      ...
      <DashboardLayout>
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">У вас нет прав для просмотра этого раздела</p>
          </div>
        </div>
      </DashboardLayout>
    );
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                {organizations.filter((org): org is Organization => !!org).map(org => (
